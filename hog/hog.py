...
def free_bacon(score):
    ...
    # 1: trim  99 digits
    # 99: trim 1 digits
    # To keep (score + 1) digits, trim (101 - (score + 1)) digits.
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    # BEGIN PROBLEM 5
    "*** YOUR CODE HERE ***"
    # def get_score(strategy, p_score, o_score, goal=goal, dice=dice):
    #     rolls = strategy(p_score, o_score)
    #     pts = take_turn(rolls, o_score, dice)
    #     p_score += pts
    #     if p_score >= goal:
    #         return p_score
    #     if extra_turn(p_score, o_score):
    ...
    while True:
        # if current_player == 0:
        #     score0 = get_score(strategy0, score0, score1, goal, dice)
        #     if score0 >= goal:
        #         break
        # else:
        #     score1 = get_score(strategy1, score1, score0, goal, dice)
        #     if score1 >= goal:
        #         break
        stg = strategy0 if current_player == 0 else strategy1
        p_score = score0 if current_player == 0 else score1
        o_score = score1 if current_player == 0 else score0

        rolls = stg(p_score, o_score)
        pts = take_turn(rolls, o_score, dice)
        p_score += pts
