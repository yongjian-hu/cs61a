...
result = add_ten(n)
+------------------------------+
Environmental diagram of the above program is:

 Frames                                    Objects
+-------------------------------+        +-------------------------------------+
| Global Frame                  |        |                                     |
|                      +--------+--------+->func make_addr(n) [parent=Global]  |
|  n: 9                |        |        |                                     |
